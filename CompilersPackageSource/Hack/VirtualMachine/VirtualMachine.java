...
public interface VirtualMachine {
     ...
     */
    void function(String functionName, int numberOfLocals);
     ...
     */
    void callFunction(String functionName, int numberOfArguments);
}
